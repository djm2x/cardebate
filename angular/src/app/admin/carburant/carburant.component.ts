...
import { Carburant } from '../../../app/shared/models';
import { MatPaginator } from '@angular/material';
import { CarburantService } from '../shared/Carburant.service';
...
export class CarburantComponent implements OnInit {
  ...
  o = new Carburant();
  isEdit = false;
  constructor(private service: CarburantService, private fb: FormBuilder) { }
