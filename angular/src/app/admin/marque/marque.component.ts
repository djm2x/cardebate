...
import { Marque } from '../../../app/shared/models';
...
export class MarqueComponent implements OnInit {
  ...
  o = new Marque();
  isEdit = false;
  countries = this.superS.get('country');
  constructor(private service: MarqueService, private superS: SuperService
  ...
  createForm() {
    this.myForm = this.fb.group({
      ...
      idCountry: [this.o.idCountry, Validators.required],
